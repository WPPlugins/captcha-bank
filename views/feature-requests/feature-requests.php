                     ...
                     <div class="form-body">
                        <div class="note note-warning">
                           ...
                           if ($cpb_message_translate_help != "") {
                              ?>
                              <strong><?php echo $cpb_message_translate_help; ?> <a href="javascript:void(0);" data-popup-open="ux_open_popup_translator" class="custom_links_feature" onclick="show_pop_up_captcha_bank();"><?php echo $cpb_message_translate_here; ?></a></strong>
                              <?php
                           }
                           ?>
                        </div>
